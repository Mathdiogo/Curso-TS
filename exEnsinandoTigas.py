def criar_personagem():
    ...
    nomeEscolhido = input("Digite seu nome: ")
    ...
    while True:
        ...
        if escolha_classe == "1":
            Escolhadeclasse = "Corajoso"
            hp_bonus = 2
            break
        elif escolha_classe == "2":
            Escolhadeclasse = "Curioso"
            hp_bonus = 1
            break
        elif escolha_classe == "3":
            Escolhadeclasse = "Compassivo"
            hp_bonus = 1
            break
        else:
            print("Escolha inválida! Tente novamente.")

    hp_Incial = 8 + hp_bonus

    print(f"\n{nomeEscolhido}, criança de classe: {Escolhadeclasse.lower()}, o Fauno te espera...")
    print(f"Você possui {hp_Incial} pontos de esperança.")
    print("ATENÇÃO: Este labirinto é perigoso e impiedoso...")

    return nomeEscolhido, Escolhadeclasse, hp_Incial
...
def JogoPrincipal():
    ...
    # JEITO CORRETO criar_personagem(nome, classe, hp)
    tem_giz = False
